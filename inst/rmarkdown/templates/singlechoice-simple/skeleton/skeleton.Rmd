...
- There is a 5% probability that you will mistakenly reject the null hypothesis (Type I error) when it is actually true.<!-- First option is treated as the correct one by default. -->
...
There is a 5% probability that you will mistakenly reject the null hypothesis (Type I error) when it is actually true.
