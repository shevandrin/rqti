...
The qti package has <<114>> tests. The test coverage of the package is `r gap_numeric(90, tolerance = 5, tolerance_type = "relative", score = 2, response_identifier = "tstCov", expected_length = 10, placeholder = "Put only digits")`%.
