...
exercises that align with your specific needs.
...
the *Knit* button to render the exercise in the viewer pane.

While the templates are generally intuitive, you can refer to other
articles of the documentation for detailed guidance on specific exercise
types. This will help you fully utilize the features of `rqti` for your
projects. The following exercise types are available:

-  [Single-Choice Exercises](articles/singlechoice.html)
-  [Multiple-Choice Exercises](articles/multiplechoice.html)
-  [Essay Exercises](articles/essay.html)
-  [Gap Exercises](articles/gap.html)
-  [Dropdown Exercises](articles/dropdown.html)
-  [Order Exercises](articles/order.html)
-  [Directed Pair Exercises](articles/directedpairs.html)
