...
```{r comment='', echo = F}
path <- system.file("rmarkdown/templates/directedpair-simple/skeleton", "skeleton.Rmd", package = "rqti")
...
If you want to have more fine-grained control, consider the RMD template ` directedpair (complex)`, which uses more yaml attributes.

```{r comment='', echo = F}
cat(readLines(system.file("rmarkdown/templates/directedpair-complex/skeleton", "skeleton.Rmd", package = "rqti")), sep = '\n')
```
