...
which will handle the preview. Clicking the Knit button in RStudio renders the file in the viewer pane. Alternatively, change the knit parameter to `knit: qti::render_opal` (see [API Opal](opal_api.html)) to upload to opal directly, producing:
