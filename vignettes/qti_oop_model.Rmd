...
`rqti` class model consists of classes that represent types of tasks (`?SingleChoice`, `?MultipleChoice`, `?Essay`, `?Entry`, `?Order`, `?DirectedPair`, `?MultipleChoiceTable`, `?OneInRowTable`, `?OneInColTable`), elements of interactive content of tasks (`?ModalFeedback`, `?CorrectFeedback`, `?WrongFeedback`, `?TextGap`, `?NumericGap`, `?InlineChoice`, `?TextGapOpal`), tests and their sections (`?AssessmentSection`, `?AssessmentTest`, `?AssessmentTestOpal`).
