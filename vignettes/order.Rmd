...
```{r comment='', echo = F}
cat(readLines(system.file("rmarkdown/templates/order-simple/skeleton", "skeleton.Rmd", package = "rqti")), sep = '\n')
```
...
```{r comment='', echo = F}
cat(readLines(system.file("rmarkdown/templates/order-complex/skeleton", "skeleton.Rmd", package = "rqti")), sep = '\n')
```
