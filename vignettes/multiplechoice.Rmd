...
You can also use the opal (set it up before, see: [API Opal](api_opal.html)) render function (`knit: qti::render_opal`), which should produce the following:

![](images/multiplechoice-simple.jpg)
...
![](images/multiplechoice-complex.jpg)
