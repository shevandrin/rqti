...
How many points are given for the whole task. Default is the number of choices times 0.5. Note that rqti usess *partial balanced scoring* for multiple choice questions.
