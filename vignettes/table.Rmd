...
```{r comment='', echo = F}
cat(readLines(system.file("rmarkdown/templates/table-simple/skeleton", "skeleton.Rmd", package = "rqti")), sep = '\n')
```
...
```{r comment='', echo = F}
cat(readLines(system.file("rmarkdown/templates/table-complex/skeleton", "skeleton.Rmd", package = "rqti")), sep = '\n')
```
