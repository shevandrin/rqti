...
This is just a typical essay exercise. A template is available in RStudio when you click on `New file -> R Markdown -> From Template`. The rqti templates start with `QTI:`. Here we look at the templates `QTI: essay (simple)` and `QTI: essay (complex)`.
