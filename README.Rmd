...
*Some Text, and then the gap: <code><<{type:text, content: {response:Right answer, alternatives:[Right answer, right answer, answer], lenghth:10, placeholder: some text, tolerance = 1}>></code> Some more text.*  
