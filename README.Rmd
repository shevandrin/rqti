...
1. Create exercise files.
    ...
    1. Choose a previewer: Either qtijs (`knit: qti::render_qtijs`), which will render your exercise locally or the learning management system Opal (`knit: qti::render_opal`). Note that using Opal requires you to set it up first: [Opal API](api_opal.html).
