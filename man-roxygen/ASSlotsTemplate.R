...
#'   attempts a candidate is allowed to make in this section.
#' @slot allow_comment A boolean value, optional, allowing the candidate to
#'   leave comments on each question of the section. Default is
#'   `TRUE`.
