#' @slot solution string vector; contains the answers which are shown in the drop
#'   down list
#' @slot answer_index numeric, optional; the index of the right answer in options
#'   vector; default `1`
