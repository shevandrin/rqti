...
eine texte Lücke, die mit der Funktion gebaut würde `r gap_text(solution = c("answer0", "answer1", "answer2"), score = 3, placeholder = "put answer here", case_sensitive = FALSE)`


eine texte Lücke **für opal**, die mit der Funktion gebaut würde `r gap_text(solution = c("answer000", "answer111", "answer222"), score = 3, placeholder = "opal allows some tolerance rate", case_sensitive = FALSE, tolerance = 2)`
