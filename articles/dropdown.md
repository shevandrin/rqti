...
oop_task <- dropdown(choices = choices, solution = "S4 OOP",
                     response_identifier = "OOP_task")
oop_task
#> [1] "<gap>{choices: ['S4 OOP', 'S3 OOP', 'no OOP', 'R6 OOP'], solution_index: 'S4 OOP', points: 1, shuffle: true, response_identifier: 'OOP_task', choices_identifiers: ['s4', 's3', 'none', 'r6'], type: 'InlineChoice'}</gap>"
```
